            ...
            <div className="fade-in-element">
              <div className="bg-white rounded-2xl shadow-elegant p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-pulse-500 to-pulse-600 text-white px-8 py-4 rounded-lg font-medium hover:from-pulse-600 hover:to-pulse-700 transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl"
                  >
