...
import billsReceivableRouter from './billsReceivable.js';
import billsPayableRouter from './billsPayable.js';
...
apiRouter.use('/bills-receivable', billsReceivableRouter);
apiRouter.use('/bills-payable', billsPayableRouter);
