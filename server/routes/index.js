...
import companySettingsRouter from './companySettings.js';
...
import customerRatesRouter from './customerRates.js';
...
import customerCleanupRouter from './customerCleanup.js';
import journalRouter from './journal.js';
import partyLedgerRouter from './partyLedger.js';
import lorryReceiptsRouter from './lorryReceipts.js';
...
apiRouter.use('/customer-rates', customerRatesRouter);
...
apiRouter.use('/customer-cleanup', customerCleanupRouter);
apiRouter.use('/journal', journalRouter);
apiRouter.use('/party-ledger', partyLedgerRouter);
apiRouter.use('/lorry-receipts', lorryReceiptsRouter);
