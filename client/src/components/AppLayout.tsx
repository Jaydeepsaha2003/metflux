...
const NAV: NavItem[] = [
  ...
  { kind: 'leaf', to: '/analysis', label: 'Analysis', icon: TrendingUp, perm: 'view_analysis' },
  {
    ...
    children: [
      ...
      { kind: 'leaf', to: '/quotation/new',    label: 'New Quotation', icon: FileText,      perm: 'add_quotation' },
      { kind: 'leaf', to: '/quotation/manage', label: 'Quotations',    icon: ClipboardList, perm: 'view_quotation' },
    ],
  },
  {
  ...
  { kind: 'leaf', to: '/returns', label: 'Return', icon: RotateCcw, perm: 'manage_returns' },
  {
    ...
    children: [
      ...
      { kind: 'leaf', to: '/accounts/party-ledger',   label: 'Party Ledger',      icon: BookOpen,     perm: 'view_party_ledger' },
      { kind: 'leaf', to: '/accounts/reconciliation', label: 'Reconciliation',    icon: Scale,        perm: 'view_reconciliation' },
