            ...
            <tbody>
              ...
              {data?.items.map((p) => (
                <tr key={p.id} className="border-t border-slate-100 odd:bg-white even:bg-slate-50/40 hover:bg-brand-50/50">
                  ...
                  <td className="px-2.5 py-2 font-ibmmono text-xs">{p.poNumber}</td>
                  <td className="px-2.5 py-2 font-ibmmono text-xs font-semibold text-brand-700">{p.customerCode ?? '—'}</td>
                  ...
                  <td className="px-2.5 py-2 font-ibmmono text-xs text-slate-700">{p.measure}</td>
